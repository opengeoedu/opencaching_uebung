...
Alternativ können Sie die Dateien auch einzeln aus dem Bedienfeld "Werkzeugkasten"-(auch Werkzeugkiste) ![Screenshot QGIS](documentation/images/werkzeugkasten_symbol.png) heraus mit Klick auf die Buttons 
![Screenshot QGIS](documentation/images/modell_symbol.png) bzw. ![Screenshot QGIS](documentation/images/skript_symbol.png) über die Optionen `Modell / Skript zum Werkzeugkasten hinzufügen...` auswählen.
